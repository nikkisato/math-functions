...
export function sum(a, b) {
    ...
    const stringOfNum = `The sum of ${a} and ${b} is ${sumOfNumber}.`;
    const mySumArray = [sumOfNumber, stringOfNum];
    return mySumArray;
}
...
/////////////////////////////////////
/* Problem 2
Write a function called multiply() that takes in two numbers as arguments and returns an array where the first element is the product of those numbers, and the second element is a string that 
...
export function sumArrayWithThreeNumbers(sumArr) {
    ...
    const sumTotal = sum(sum1, sumArr[2])[0];
    const string = `The numbers ${sumArr[0]},${sumArr[1]},${sumArr[2]} have a sum of ${sumTotal}.`;
    const array = [sumTotal, string];
    return array;
}
...
export function multiplyArrayWithThreeNumbers(multArr) { //eslint-disable-line
    ...
    const mult = multiply(multArr[0], multArr[1])[0];
    const mulTotal = multiply(mult, multArr[2])[0];
    const string = `The numbers ${multArr[0]},${multArr[1]},${multArr[2]} have a product of ${mulTotal}.`;
    const array = [mulTotal, string];
    return array;
}
